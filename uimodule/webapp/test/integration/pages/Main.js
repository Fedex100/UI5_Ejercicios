sap.ui.require([
  ...
  var sViewName = "com.te.oDataSalesOrderSearch.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "com.te.oDataSalesOrderSearch"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title com.te.oDataSalesOrderSearch"
            });
        }
      }
